...
<html <?php language_attributes(); ?>>
    <head>
        ...
        <link rel="preload" href="<?php echo get_stylesheet_directory_uri(); ?>/css/fonts/standard-icons/icomoon.ttf"
        ...
        <div class="backgroundmenu">
            <div class="container">
                <div class="row">
                    ...
                    <div class="buttonsmenu col-3 col-sm-8 d-flex justify-content-end align-items-center">
                        <div class="d-flex flex-row justify-content-end align-items-center">
                            <a href="#" class="me-2">
                                <div class="mylist position-relative d-none d-md-flex justify-content-end align-items-center">
                                    <span class="title text-uppercase">My List</span><i class="icon-cart"></i>
                                </div>
                            </a>
                            <a href="#">
                                <div class="menu">
                    ...
                    <div class="col-3 col-sm-8 d-flex justify-content-end align-items-center">
                        <?php if (has_nav_menu('mobile-nav')) : ?>
                            <div class="mobile-nav-toggle"><img
                                        src="<?php _e(get_stylesheet_directory_uri()); ?>/img/nav-burger.svg" width="45"
                                        height="45" alt="nav-toggle"></div>
