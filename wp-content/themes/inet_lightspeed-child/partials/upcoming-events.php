...
<section class="events__backgroundimage">
    <section class="events__wrapper">
        <section class="container d-flex align-items-start row mx-auto justify-content-between">
                            ...
                            <div class="d-flex align-items-start mt-1 gap-1">
                                ...
                                <div>
                                    ...
                                    <?php if (!empty($row['time_event_starts_day_two']) && !empty($row['time_event_ends_day_two'])): ?>
                                        <p class="mb-0 h6 time__eventtwo"><?= esc_html($dateTwo['dayOfWeek']) . ' ' . str_replace(' ', '', esc_html($row['time_event_starts_day_two'])) . ' - ' . str_replace(' ', '', esc_html($row['time_event_ends_day_two'])); ?></p>
                                    <?php endif; ?>
                                </div>
                            </div>
                        </section>
